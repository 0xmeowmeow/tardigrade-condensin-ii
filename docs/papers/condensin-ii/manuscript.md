...
With the first SMC2 construct, the N-terminal regions gave no signal (Fig. 4b). Human CAP-H2 was placed on the SMC2 neck at 0.67, but every tardigrade N-terminal region scored 0.29–0.48, no better than its own controls. We repeated the prediction with a longer SMC2 construct that includes more of the neck, with five samples per pair (Methods; Fig. 4c). The N-terminal regions of the b copies of *H. exemplaris* and *R. varieornatus* are now placed on SMC2 in all five samples: ipTM 0.62–0.67 (median 0.65) and 0.64–0.69 (median 0.65), against 0.57–0.61 (median 0.58) for human CAP-H2. Their interfaces have 49 and 39 confidently placed kleisin residues in contact with SMC2 (pLDDT at least 70), against 39 for human. Scrambled versions of the human and *H. exemplaris* b regions score medians of 0.19 and 0.11, with no confidently placed interface residues; the best of five scrambled human samples reaches 0.52. The b copies contact the same stretch of the SMC2 neck as human CAP-H2: residues about 168–250 and 990–1055 of their own SMC2, against human residues 168–232 and 992–1048. *H. exemplaris* a (median 0.12) and *Paramacrobiotus* b (median 0.35) show no support with either construct; the a copies of the other two species were not retried. So copy b is predicted to close the ring at both ends, and the N-terminal result with the short construct reflected the construct rather than the tardigrade sequences. Figure 5 shows one of the confident C-terminal models in 3D.

![**Predicted binding of the CAP-H2 regions to the condensin ring.** Interface confidence (ipTM) of Boltz-2 predictions, best of three samples (five in c); bars show the range across samples. (a) CAP-H2 C-terminal regions with the same species' SMC4 head, the *H. exemplaris* condensin I kleisin CAP-H with SMC4 (green), and controls: the region offered SMC2 instead (wrong partner) or with its residues shuffled (grey). (b) CAP-H2 N-terminal regions with the first SMC2 head-and-neck construct, and the same controls. (c) N-terminal regions with a longer SMC2 construct (best of five samples): the b copies of *H. exemplaris* and *R. varieornatus* are placed as confidently as human CAP-H2; scrambled controls in grey. The dotted line marks 0.8, above which predicted interfaces are usually correct.](figs/fig4-structure.pdf){width=100%}
